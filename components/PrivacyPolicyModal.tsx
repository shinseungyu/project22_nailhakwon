  ...
  return (
    <>
      <button
        ...
        style={{ color: "#a8a29e", textDecoration: "none", fontWeight: "500", background: "none", border: "none", cursor: "pointer", fontSize: "14px", padding: 0 }}
      >
        개인정보처리방침
      </button>
          ...
          <div style={{ backgroundColor: "#fff", borderRadius: "1rem", width: "100%", maxWidth: "680px", maxHeight: "85dvh", display: "flex", flexDirection: "column", overflow: "hidden" }}>
            ...
            <div style={{ overflowY: "auto", padding: "1.5rem", fontSize: "0.875rem", lineHeight: 1.8, color: "#374151" }}>
              <p style={{ marginBottom: "1.5rem" }}>
                ...
                본 개인정보처리방침은 &apos;네일아트학원 수강 상담 안내&apos; 서비스에 적용됩니다.
              </p>
              ...
              <Section title="제1조 (개인정보의 처리 목적)">
                ...
                나) 네일아트학원 수강 상담, 커리큘럼 안내 및 관련 서비스 제공<br />
              ...
              <Section title="제6조 (개인정보의 제3자 제공)">
                ...
                <b>제공받는 자:</b> 네일아트학원 수강 상담 전문 강사<br />
                <b>제공 목적:</b> 네일아트학원 수강 상세 상담 및 관련 안내<br />
